...
#import <YYText/YYLabelAnimationDelegate.h>
#else
#import "YYTextParser.h"
#import "YYTextLayout.h"
#import "YYTextAttribute.h"
#import "YYLabelAnimationDelegate.h"
#endif
...
/**
 Dispatch -[UIView actionForLayer:forKey:]
 */
@property (nullable, nonatomic, weak) id<YYLabelAnimationDelegate> animationDelegate;
...
/**
 Fix bug : highlight animation will be enabled when update properties, even though `fadeOnHighlight` is `YES`
...
/// Call default -[UIView actionForLayer:forKey:]
/// @param layer layer
/// @param event event
- (id<CAAction> _Nullable)defaultActionForLayer:(CALayer * _Nonnull)layer forKey:(NSString * _Nonnull)event;
